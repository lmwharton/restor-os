  ...
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" aria-hidden="true">
      <path
        ...
        fill="url(#dropGradTeam)"
        stroke="#a63500"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <defs>
        <linearGradient id="dropGradTeam" x1="6" y1="3" x2="22" y2="25" gradientUnits="userSpaceOnUse">
    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-24 md:pb-12 relative">
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(146,74,48,0.08) 0%, transparent 70%)" }}
          aria-hidden="true"
        />
        ...
        <div className="relative flex flex-col items-center text-center max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-surface-container flex items-center justify-center mb-6">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <circle cx="9" cy="7" r="3.5" stroke="#a63500" strokeWidth="1.5" />
              <path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7" stroke="#a63500" strokeWidth="1.5" strokeLinecap="round" />
              <circle cx="17" cy="9" r="2.5" stroke="#a63500" strokeWidth="1.5" />
              <path d="M17 14c2.8 0 5 2.2 5 5" stroke="#a63500" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          </div>
          ...
          <p className="text-[15px] text-on-surface-variant leading-relaxed mb-8 max-w-sm">
            Invite techs, assign roles, and manage who has access to your company workspace.
          </p>
